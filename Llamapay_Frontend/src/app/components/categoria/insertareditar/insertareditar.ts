...
export class InsertareditarCategoria implements OnInit{ //4
  ...
  constructor(private cS: CategoriaService,private router: Router,private formBuilder: FormBuilder, private route: ActivatedRoute){ //tiene que ser del angular material
  }
  ngOnInit(): void {

    this.route.params.subscribe((data: Params) => {
      console.log('Parámetros de ruta:', data);
      this.id = data['id']
